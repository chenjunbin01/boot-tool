...
public class CacheManager {
     ...
     * 前缀
     */
    private static final String KEY_PREFIX_VALUE = "cjb:value:";
    private static final String KEY_PREFIX_SET = "cjb:set:";
    private static final String KEY_PREFIX_LIST = "cjb:list:";
